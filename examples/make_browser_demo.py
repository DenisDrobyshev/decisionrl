...
from decisionrl.zoo import save_to_zoo
...
<title>decisionrl — watch a trained agent play</title>
<style>
...
<h1>decisionrl &mdash; PPO plays CartPole</h1>
<div class="sub">A policy trained with <code>decisionrl</code>, running entirely in your browser (no server).</div>
...
// --- CartPole dynamics (matches decisionrl.envs.CartPole) ---
