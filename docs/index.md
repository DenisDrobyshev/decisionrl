...
- **20 algorithms** — tabular (Q-Learning, SARSA, Expected SARSA), model-based
  (Dyna-Q), value-based (DQN, C51, QR-DQN, **Rainbow**), policy gradient
  (REINFORCE, A2C, PPO, Recurrent PPO, discrete SAC), continuous control
  (DDPG, TD3, SAC), offline (TD3+BC, IQL, CQL) — plus multi-agent PPO
  (self-play / IPPO).
